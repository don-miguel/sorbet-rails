...
T.assert_type!(spell_books.find_or_initialize_by(name: "Fantastic Beasts") { |s|
  T.assert_type!(s, SpellBook)
}, SpellBook)
...
T.assert_type!(spell_books_query.find_or_initialize_by(name: "Fantastic Beasts") { |s|
  T.assert_type!(s, SpellBook)
}, SpellBook)
T.assert_type!(spell_books_query.find_or_create_by(name: "Fantastic Beasts") { |s|
  T.assert_type!(s, SpellBook)
}, SpellBook)
T.assert_type!(spell_books_query.find_or_create_by!(name: "Fantastic Beasts") { |s|
  T.assert_type!(s, SpellBook)
...
T.assert_type!(spell_books_query.build { |s|
  T.assert_type!(s, SpellBook)
}, SpellBook) # Ignored until we add support # Ignored until we add support
T.assert_type!(spell_books_query.create(name: "Fantastic Beasts") { |s|
  T.assert_type!(s, SpellBook)
}, SpellBook) # Ignored until we add support
T.assert_type!(spell_books_query.create!(name: "Fantastic Beasts") { |s|
  T.assert_type!(s, SpellBook)
}, SpellBook) # Ignored until we add support
T.assert_type!(spell_books_query.first_or_create(name: "Fantastic Beasts") { |s|
  T.assert_type!(s, SpellBook)
}, SpellBook) # Ignored until we add support
T.assert_type!(spell_books_query.first_or_create!(name: "Fantastic Beasts") { |s|
  T.assert_type!(s, SpellBook)
}, SpellBook) # Ignored until we add support
T.assert_type!(spell_books_query.first_or_initialize { |s|
  T.assert_type!(s, SpellBook)
}, SpellBook) # Ignored until we add support
